...
souseRouter.route('/p/upload/:id').post(postController.upload_post_image);
...
souseRouter.route('/p/delete/postimage/:id').get(postController.delete_post_image); // Routes for Comments
