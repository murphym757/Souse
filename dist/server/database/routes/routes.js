...
souseRouter.route('/u/upload/:id').post(userController.upload_user_image);
...
souseRouter.route('/u/delete/userimage/:id').get(userController.delete_user_image);
souseRouter.route('/u/delete/all/userimage/:id').get(userController.delete_all_user_images);
...
souseRouter.route('/p/add/:postCreator').post(postController.create_post);
souseRouter.route('/p').get(postController.find_post);
souseRouter.route('/p/upload/:id/:postCreator/:postUnixTimestamp').post(postController.upload_post_image);
...
souseRouter.route('/p/delete/postimage/:id/:postCreator/:postUnixTimestamp').get(postController.delete_post_image); // Routes for Comments
