...
var SouseUserPageIconLanding = _styledComponents["default"].div.withConfig({
  ...
  return props.theme.secondaryColor;
}, _mainStyling.souseMediaQueries.mobileS.portrait, _mainStyling.souseMediaQueries.mobileM.portrait, _mainStyling.souseMediaQueries.mobileL.portrait, _mainStyling.souseMediaQueries.tablet.portrait, _mainStyling.souseMediaQueries.laptop.portrait, _mainStyling.souseMediaQueries.mobileS.landscape, _mainStyling.souseMediaQueries.mobileM.landscape, _mainStyling.souseMediaQueries.mobileL.landscape, _mainStyling.souseMediaQueries.tablet.landscape, _mainStyling.souseMediaQueries.laptop.landscape, _mainStyling.souseMediaQueries.laptopL.landscape, _mainStyling.souseMediaQueries.desktop.landscape);
/* ---------------------------------------------------- */
...
})(["img{height:25vw;width:25vw;}@media ", ",", ",", " ", ",", "{-ms-flex:0 0 100%;flex:0 0 100%;max-width:100%;img{height:50vw;width:50vw;}}@media ", ",", ",", " ", ",", ",", ",", "{-ms-flex:0 0 50%;flex:0 0 50%;max-width:50%;img{height:25vw;width:25vw;}}@media ", ",", "{h5{font-size:0.9rem;}}@media ", ",", ",", "{h5{font-size:0.5rem;}}@media ", ",", "{h5{font-size:1rem;}}"], _mainStyling.souseMediaQueries.mobileS.portrait, _mainStyling.souseMediaQueries.mobileM.portrait, _mainStyling.souseMediaQueries.mobileL.portrait, _mainStyling.souseMediaQueries.tablet.portrait, _mainStyling.souseMediaQueries.laptop.portrait, _mainStyling.souseMediaQueries.mobileS.landscape, _mainStyling.souseMediaQueries.mobileM.landscape, _mainStyling.souseMediaQueries.mobileL.landscape, _mainStyling.souseMediaQueries.tablet.landscape, _mainStyling.souseMediaQueries.laptop.landscape, _mainStyling.souseMediaQueries.laptopL.landscape, _mainStyling.souseMediaQueries.desktop.landscape, _mainStyling.souseMediaQueries.mobileS.landscape, _mainStyling.souseMediaQueries.mobileS.portrait, _mainStyling.souseMediaQueries.mobileL.landscape, _mainStyling.souseMediaQueries.mobileM.landscape, _mainStyling.souseMediaQueries.tablet.landscape, _mainStyling.souseMediaQueries.mobileL.portrait, _mainStyling.souseMediaQueries.mobileM.portrait);
/* ---------------------------------------------------- */
// Bio Section
